...
st.set_page_config(page_title="Youtube Data Harvesting and Warehousing | By Divya",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This app is created by *Divya!*"""})
...
client = pymongo.MongoClient("mongodb+srv://divyadhyanesh:Akpksd1234@cluster0.lhgspq2.mongodb.net/?retryWrites=true&w=majority")
